...
# driver.get("https://www.youtube.com/watch?v=pUUhvJvs-R4&t=214s")
# driver = webdriver.Chrome("C:/Users/parul/Documents/AI CAMP/openai/chromedriver.exe")
import csv
from selenium import webdriver
...
parent_element = driver.find_element(By.CSS_SELECTOR,'[class="staff-list desktop template-1"]')
...
with open('staff_data.csv', 'w', newline='') as csvfile:
    ...
    for li_tag in li_tags:
        ...
        # get designation
        try:
            designation = li_tag.find_element(By.CSS_SELECTOR,'[class="user-position user-data"]')
...
#staff_861954_0 > div:nth-child(2) > div:nth-child(2) > span:nth-child(1) > a:nth-child(1)ś
